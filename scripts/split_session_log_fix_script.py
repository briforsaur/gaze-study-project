...
def get_args():
    ...
    parser.add_argument(
        ...
        type=Path,
        help=(
            "A list of paths to two log files. The second file will be appended to "
            "the first."
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        help=(
            "The amount to offset the trial and calibration numbers from the second "
            "log"
        ),
    )
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Flag to indicate if the last trial of both logs should be trimmed, "
...
def main(
    ...
    for record in _RECORD_NAMES:
        ...
        offset_record(
            logs[1][record], trial_offset, t_offset, rec_offset, calibration=calib
        )
